...
def joke():
    joke_txt = [
        ...
        "The beginning of the programmer's wisdom is understanding the difference between getting program"
        " to run and having a runnable program\n",
        ...
        ' would just tell them to open the airlock, flush the astronauts out, and re-install new one\n',
