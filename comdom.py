...
elements={' H':1.0, ' C':12.0, ' N':14.0, ' O':16.0, ' P':31.0, ' S':32.0}    
...
while n<len(s_array):
    ...
    if s.find('t=')!=-1:
        ...
        xyzm_1=[float(s[30:38]), float(s[38:46]), float(s[46:54]), elements[s[76:78]]]
        ...
        print("Координаты центра массс первого домена: "+str(c_mass_1)+"\n"+"второго домена: "+str(c_mass_2)+"\n"+"расстояние: "+str(r)+" A")
        r_array.append(r)
        del xyzm_array_1
        del xyzm_array_2
        xyzm_array_1=[]
